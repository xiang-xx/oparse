...
//
// Solidity: function burn_from(address account, uint256 amount) returns(bool)
func (_Store *StoreTransactor) BurnFrom(opts *bind.TransactOpts, account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Store.contract.Transact(opts, "burn_from", account, amount)
}
...
// MintInto is a paid mutator transaction binding the contract method 0xefe51695.
//
// Solidity: function mint_into(address account, uint256 amount) returns(bool)
func (_Store *StoreTransactor) MintInto(opts *bind.TransactOpts, account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Store.contract.Transact(opts, "mint_into", account, amount)
}

// MintInto is a paid mutator transaction binding the contract method 0xefe51695.
//
// Solidity: function mint_into(address account, uint256 amount) returns(bool)
func (_Store *StoreSession) MintInto(account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Store.Contract.MintInto(&_Store.TransactOpts, account, amount)
}

// MintInto is a paid mutator transaction binding the contract method 0xefe51695.
//
// Solidity: function mint_into(address account, uint256 amount) returns(bool)
func (_Store *StoreTransactorSession) MintInto(account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Store.Contract.MintInto(&_Store.TransactOpts, account, amount)
}
